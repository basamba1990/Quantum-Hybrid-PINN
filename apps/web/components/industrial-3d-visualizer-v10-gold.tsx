...
/**
 * VISUALISEUR 3D V10 GOLD - TRULY INDUSTRIAL
 * - Axes X,Y,Z gradués avec chiffres intermédiaires
 * - Cage 3D industrielle complète (bounding box filaire)
 * - Étiquettes d'axes précises
...
const Industrial3DVisualizerV10Gold: React.FC<Props> = ({ 
  ...
  useEffect(() => {
    ...
    const axisLength = Math.max(xMax - xMin, yMax - yMin, zMax - zMin)
