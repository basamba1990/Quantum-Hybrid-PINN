...
\begin{table}[H]
    ...
    \begin{tabular}{lcccc}
        ...
        \midrule
        \textbf{Heavy-Duty Refueling} & $1,15 \times 10^{-7}$ & $3,42 \times 10^{-7}$ & $5,89 \times 10^{-7}$ & $99,50$ \\
        \textbf{LH2 Large Storage} & $2,10 \times 10^{-7}$ & $4,22 \times 10^{-7}$ & $6,32 \times 10^{-7}$ & $99,50$ \\
        \bottomrule
    \end{tabular}
\end{table}
