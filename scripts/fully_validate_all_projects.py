...
def main():
    ...
    print(f"Trouvé {len(analyses)} analyses dans la base de données.")
    ...
    for analysis in analyses:
        ...
        print(f"\nTraitement - Nom: {name} | Scenario: {scenario} | Project ID: {pid}")
        ...
        # Update / Insert analysis_results (only valid columns)
        result_data = {
        ...
        print(f"  -> Validé et persisté avec succès.")
